...
subtitle: Simple ways to manage Python projects without unnecessary complexity
description: A pragmatic approach to organizing related Python scripts, running modules correctly, and debugging them in VS Code.
date: 2024-12-05
lastmod: 2024-12-05
slug: python-messy-org
author: Thiago MadPin
image: cover.png
imageAlt: An illustration of taming a messy collection of Python scripts
categories: [Tech]
tags: [python, project-structure, debugging]
aliases:
  - /2024/12/05/python-messy-org/
---

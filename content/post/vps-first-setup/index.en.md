...
draft: false
title: "VPS: My Oracle Cloud ARM Server Setup"
subtitle: How I secured a free Oracle Cloud VPS and lived to tell the tale
description: A practical walkthrough of user management, SSH hardening, Fail2Ban, unattended upgrades, Docker, Git, and shell setup on an Oracle Cloud ARM server.
date: 2024-12-19
lastmod: 2024-12-19
slug: vps-first-setup
author: Thiago MadPin
image: cover.jpg
imageAlt: A computer server illustrated as a superhero
categories: [Tech]
tags: [vps, linux, docker, ssh, ubuntu, cloud]
---

...
draft: false
title: "Building a Shift Scheduling System: From Spreadsheet Chaos to Open Source"
subtitle: A community-focused system for managing healthcare on-call duty
description: A concept for replacing WhatsApp and spreadsheet-based hospital shift management with an open-source, user-centered scheduling system.
date: 2024-12-07
lastmod: 2024-12-07
slug: building-a-shift-scheduling-system-from-spreadsheet-chaos-to-open-source-solution
author: Thiago MadPin
image: cover.webp
imageAlt: A healthcare shift scheduling dashboard
categories: [Tech]
tags: [ideas, projects, open-source, healthcare]
---
...
> [!NOTIFY]
> Interested in this idea? Connect with me on [GitHub](https://github.com/madpin). I am particularly interested in hearing from healthcare professionals about their experiences and needs. *Juntos, podemos fazer a diferença!* (Together, we can make a difference!)
